...
VALUES ("Cardigan", "Clothing", 25.05, 9),
        ("Jeans", "Clothing", 48.96, 10),
        ("Scarf", "Clothing", 12.65, 5),
        ("IPad", "Electronics", 1300.91, 4),
        ("Iphone", "Electronics", 1285.52, 8),
...
-- This table is for the supervisors function which was not finished
